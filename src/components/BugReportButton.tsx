  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-40 bg-destructive text-destructive-foreground p-3 rounded-full shadow-lg hover:scale-105 transition-transform flex items-center gap-2 group"
        title="Reportar erro"
      >
