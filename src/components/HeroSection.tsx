      ...
      <div className="container mx-auto px-4 relative z-10 pt-24">
        <div className="max-w-4xl">
          ...
          <motion.p
            ...
            A Movê existe para apoiar jovens em diferentes momentos da sua jornada profissional — oferecendo orientação prática, acesso a conhecimento e conexão com mentores voluntários. Somos um projeto 100% social.
